 ...
 * In production, all commands are registered under the extension name for consistency.
 */
const ClineCommands = {
 ...
 */
const ClineViewIds = {
	/** The chat webview. Lives in the secondary (right) side bar. */
	Sidebar: name + ".SidebarProvider",
	/** Activity bar placeholder whose only job is to reveal `Sidebar`. */
