...
export class StateManager {
	...
	private setRemoteConfigState(updates: Partial<GlobalStateAndSettings>): void {
		...
		// does not use. This method is now a no-op passthrough kept only
		// because other code still calls it; the remote config cache is never
		// populated since there is no backend to fetch it from.
