...
async function performCommitMsgGeneration(controller: Controller, gitDiff: string, inputBox: GitRepositoryInputBox) {
	try {
		vscode.commands.executeCommand("setContext", "openprovider.isGeneratingCommit", true)
		...
		vscode.commands.executeCommand("setContext", "openprovider.isGeneratingCommit", false)
	}
}
