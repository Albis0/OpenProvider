...
export function convertApiConfigurationToProto(config: ApiConfiguration): ProtoApiConfiguration {
	return {
		...
		planModeNvidiaModelId: config.planModeNvidiaModelId,
		...
		actModeNvidiaModelId: config.actModeNvidiaModelId,
...
export function convertProtoToApiConfiguration(protoConfig: ProtoApiConfiguration): ApiConfiguration {
	return {
		...
		planModeNvidiaModelId: protoConfig.planModeNvidiaModelId,
		...
		actModeNvidiaModelId: protoConfig.actModeNvidiaModelId,
