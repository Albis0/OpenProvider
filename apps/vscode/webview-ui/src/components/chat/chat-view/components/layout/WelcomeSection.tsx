...
export const WelcomeSection: React.FC<WelcomeSectionProps> = ({
	...
	// Cline-account auth has been removed along with the account/billing system
	// this fork does not use, so there is no Cline user to key banners off of.
	const clineUser = null
	const {
		openRouterModels,
		navigateToSettings,
								...
								{currentWorktree && (
									<Tooltip>
										...
										<TooltipContent side="bottom">
											View and manage git worktrees. Great for running parallel OpenProvider tasks.
										</TooltipContent>
									</Tooltip>
								)}
							</div>
