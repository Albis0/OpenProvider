	...
	return (
		<div
			...
			<div
				...
				className="group cursor-pointer py-2 pr-2 px-3.5 flex items-center justify-between gap-0 text-xs text-description hover:text-foreground transition-colors"
				onClick={() => {
