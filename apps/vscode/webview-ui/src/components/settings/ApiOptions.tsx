	...
	*/
	...
	return (
		<div
			...
			{/*
			 * Cline account/billing has been removed along with the account
			 * system this fork does not use, so the "cline" and "cline-pass"
			 * provider settings panels (account balance, model picker tied to
			 * Cline credits) have been removed too. The provider IDs themselves
			 * are left selectable elsewhere (provider list, model catalog) since
			 * untangling them from the rest of the provider system is out of
			 * scope -- selecting them here now simply shows no configuration UI.
			 */}
