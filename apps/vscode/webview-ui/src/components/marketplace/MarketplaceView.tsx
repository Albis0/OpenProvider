...
const PRIMITIVES: PrimitiveConfig[] = [
	{
		...
		description: (
			<>
				Reusable instruction sets that OpenProvider loads on demand for specific tasks, without staying in context for
	...
	},
	{
		...
		description: (
			<>
				Connect OpenProvider to external APIs, local tools, and hosted services through{" "}
	...
	},
	{
		...
		description: (
			<>
				<VSCodeLink href="https://github.com/Albis0/OpenProvider">Plugins</VSCodeLink> are extensions for capabilities
				more complex than a single MCP server or skill, including custom tools, hooks, rules, slash commands, or bundled
				skills.
			</>
		),
		icon: PuzzleIcon,
