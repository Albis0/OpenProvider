...
export const createStorybookDecorator =
	// The third parameter (Cline-account auth overrides) has been removed
	// along with ClineAuthContext -- kept as an accepted-but-ignored parameter
	// so existing call sites that still pass it don't need to be touched.
		(overrideStates?: Partial<ExtensionStateContextType>, classNames?: string, _authOverrides?: Record<string, unknown>) =>
		(Story: any) => (
